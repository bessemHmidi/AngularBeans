...
/**
 * this class declare the angularBeans Module name that will be generated and used as an AngularJs module dependency (in
 * this case : "angularBeans")
 * 
 * @author bessem hmidi
 **/

@NGApp
public class AngularBeans { //
